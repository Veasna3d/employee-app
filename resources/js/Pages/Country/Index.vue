                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="flex justify-between items-center p-4">
                        ...
                        Add New</Link>
                            ...
                            <select v-model="perPage" @change="getCountries" id="countries"
                            ...
                            <tbody>
                                <tr v-for="country in countries.data" :key="country.id"
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex">
                                            <Link :href="route('countries.edit', country.id)"><svg
                                            ...
                                            <Link :href="route('countries.destroy', country.id)" method="delete"
